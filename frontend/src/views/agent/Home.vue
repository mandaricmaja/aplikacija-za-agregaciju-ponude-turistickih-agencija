  ...
  <div>
    <div id="hero" class="d-flex flex-column justify-content-center">
      <div class="container text-center text-md-left">
        ...
        <h3>Dodaj novu turističku ponudu i prati rezervacije!</h3>
      </div>
    </div>

    <div class="title">
      <h1>OBJAVLJENE PONUDE PUTOVANJA</h1>
    </div>
    ...
    <div class="menu-all-place">
      <div class="menu-full">
        <div class="menu-container">
          <div class="row">
            <div v-for="offer in offers" :key="offer.id" class="col-sm-4 item-each">
              <div class="card">
                <div class="card-body">
                  <router-link :to="{name:'AgentOfferDetails', params:{id:offer.id}}">
                    <img :src="offer.fotografija" class="fotografija" alt="Paris" width="368" height="225">
  ...
  methods: {
    async getTravelOffers() {
      try {
        ...
        let response = await fetch(`http://localhost:8000/agents/${this.id}/offers`, args)
